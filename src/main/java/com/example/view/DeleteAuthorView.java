...
public class DeleteAuthorView extends JFrame implements AuthorView {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DeleteAuthorView frame = new DeleteAuthorView();
	...
	public DeleteAuthorView() {
		...
		btnDelete.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(table.getSelectedRow() != -1) {
					...
					showresult(miController.deleteAuthor(selectedAuthorId));
				...
				dtm.setRowCount(0);
				authors.clear();
				miController.showDeleteAuthors();
				showAuthors();
			}
		});
		...
		textResults.setBounds(278, 473, 467, 66);
